...
# FDE 구현 (GPU 버전 사용)
from fde_generator_gpu_optimized_triple_stream_with_mini_batch_optimized import (
...
TOP_K = 10
FILENAME = "main_weight_fde_gpu_triple_stream_with_mini_batch_optimized"
...
class ColbertFdeRetriever:
    ...
    def index(self, corpus: dict):
        ...
        ATOMIC_BATCH_SIZE = 4000  # 배치 크기 (메모리 매핑으로 안전하게 처리)
