...
def generate_document_fde_batch_gpu(
    ...
    *,
    ...
    total_measured_time = prep_time + simhash_time + scatter_time + avg_time + transfer_time
    ...
    _GPU_CUMULATIVE_TIMING['average_time'] += avg_time
    _GPU_CUMULATIVE_TIMING['transfer_time'] += transfer_time
